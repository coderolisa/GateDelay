...
export class NetworkService {
  ...
  private initializeNetworks(): void {
    const mainnet: NetworkConfig = {
      ...
      contractAddresses: {
        market:
          process.env.MAINNET_MARKET_ADDRESS ||
          '0x0000000000000000000000000000000000000001',
        trading:
          process.env.MAINNET_TRADING_ADDRESS ||
          '0x0000000000000000000000000000000000000002',
        liquidity:
          process.env.MAINNET_LIQUIDITY_ADDRESS ||
          '0x0000000000000000000000000000000000000003',
        collateral:
          process.env.MAINNET_COLLATERAL_ADDRESS ||
    ...
    const testnet: NetworkConfig = {
      ...
      contractAddresses: {
        market:
          process.env.TESTNET_MARKET_ADDRESS ||
          '0x0000000000000000000000000000000000000005',
        trading:
          process.env.TESTNET_TRADING_ADDRESS ||
          '0x0000000000000000000000000000000000000006',
        liquidity:
          process.env.TESTNET_LIQUIDITY_ADDRESS ||
          '0x0000000000000000000000000000000000000007',
        collateral:
          process.env.TESTNET_COLLATERAL_ADDRESS ||
    ...
    const polygon: NetworkConfig = {
      ...
      contractAddresses: {
        market:
          process.env.POLYGON_MARKET_ADDRESS ||
          '0x0000000000000000000000000000000000000009',
        trading:
          process.env.POLYGON_TRADING_ADDRESS ||
          '0x0000000000000000000000000000000000000010',
        liquidity:
          process.env.POLYGON_LIQUIDITY_ADDRESS ||
          '0x0000000000000000000000000000000000000011',
        collateral:
          process.env.POLYGON_COLLATERAL_ADDRESS ||
